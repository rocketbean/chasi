module.exports = class UserVerification {
    constructor(config, property) {
        this.config = config
        this.property = property
        this.link = config.authentication.baseUrl + config.authentication.verificationUrl + `/${property.verification._id}`
    }
    ...
    <![endif]-->
      ...
      <tbody><tr>
        <td role="module-content">
          <p>CastMonkeys knows your style!</p>
        </td>
      </tr>
        ...
        <tbody><tr>
          <td style="font-size:6px; line-height:10px; padding:20px 0px 0px 0px;" valign="top" align="center">
            <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:50% !important; width:8%; height:auto !important;" src="logo.png" alt="Chasi" width="75" data-responsive="true" data-proportionally-constrained="false">
          </td>
        </tr>
        ...
        <tbody><tr>
          <td style="background-color:#ffffff; padding:50px 0px 10px 0px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="#ffffff"><div><div style="font-family: inherit; text-align: center"><span style="color: #516775; font-size: 28px; font-family: georgia,serif"><strong>Welcome to CastMonkeys!</strong></span></div><div></div></div></td>
        </tr>
        ...
        <tbody><tr>
          <td style="background-color:#ffffff; padding:10px 40px 50px 40px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="#ffffff"><div><div style="font-family: inherit; text-align: center"><span style="font-family: verdana,geneva,sans-serif">Thanks for signing up to CastMonkeys! You're one step closer on joining our tribe! Please click the button below to verify this email.</span></div><div></div></div></td>
        </tr>
          <tr  style="background-color:#ffffff; ">
              <td align="center" bgcolor="#993300" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;"><a style="background-color:#993300; border:1px solid #993300; border-color:#993300; border-radius:0px; border-width:1px; color:#ffffff; display:inline-block; font-family:verdana,geneva,sans-serif; font-size:16px; font-weight:normal; letter-spacing:1px; line-height:30px; padding:12px 20px 12px 20px; text-align:center; text-decoration:none; border-style:solid;margin-bottom:10px" href="${this.link}" target="_blank">Verify!</a>
              </td>
          </tr>
    ...
    <table class="module" role="module" data-type="spacer" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="qkfYAswHNSwNpwb1p7m4gC">
        <tbody>
        <tr>
          <td style="padding:0px 0px 30px 0px;" role="module-content" bgcolor="">
          </td>
      ...
      <div class="Unsubscribe--addressLine"><p class="Unsubscribe--senderName" style="font-family:arial,helvetica,sans-serif; font-size:12px; line-height:20px;">https://castmonkeys.com</p><p style="font-family:arial,helvetica,sans-serif; font-size:12px; line-height:20px;">
      </p></div>
