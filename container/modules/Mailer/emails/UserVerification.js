      ...
      <tbody><tr>
        ...
        <tbody><tr>
          <td style="font-size:6px; line-height:10px; padding:20px 0px 0px 0px;" valign="top" align="center">
            <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:50% !important; width:8%; height:auto !important;" src="https://storage.googleapis.com/bucket_banana/defaults/Untitled-1.jpg" alt="CastMonkeys" width="75" data-responsive="true" data-proportionally-constrained="false">
          </td>
        </tr>
